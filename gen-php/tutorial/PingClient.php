...
class PingClient implements \tutorial\PingIf {
  ...
  {
    $args = new \tutorial\Ping_ping_args();
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) {
        ...
        echo '1111'.PHP_EOL;
        $result = thrift_protocol_read_binary($this->input_, '\tutorial\Ping_ping_result', $this->input_->isStrictRead());
    }
    else
    {
      $rseqid = 0;
      ...
      $result = new \tutorial\Ping_ping_result();
